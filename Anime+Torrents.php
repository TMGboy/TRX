...
// Local JSON Section for Anime Category
// -------------------------------------
$trends = './minidb/anime_cat_1.json';
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:top; padding: 3px 5px 0 10px; width: 100%">
                                        ...
                                        <tr>
                                            <td>
                                                <span style="padding: 0px 10px;">
                                                    ...
                                                    <a href="/Anime+Torrents.php" title="Browse Anime torrents">Anime torrents</a>
                                                </span>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table border="0" cellspacing="1" cellpadding="3">
                                        <tbody>
                                            <tr>
                                                <td><img src="/images/1.gif" border="0" alt="Apps"></td>
                                                <td style="padding-bottom:20px;">
                                                    <a href="/category/123558/Anime+Torrents.php" title="Browse Anime torrents" class="h1"><b>Anime torrents</b></a>
                                                </td>
                                                <td style="padding-bottom:20px;">&gt;</td>
                                                <td style="padding-bottom:20px;">
                                                    <h1><b>Anime torrents</b> </h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
