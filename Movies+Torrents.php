    ...
    <tr>
        ...
        <td style="vertical-align:top; padding: 3px 5px 0 10px; width: 100%">
            ...
            <table border="0" cellspacing="1" cellpadding="3">
                <tbody>
                    <tr>
                        <td><img src="/images/4.gif" border="0" alt="Movies"></td>
                        <td style="padding-bottom:20px;">
                            <a href="/category/123558/Movies+Torrents.php" title="Browse Movies torrents" class="h1"><b>Movies torrents</b></a>
                        </td>
                        <td style="padding-bottom:20px;">&gt;</td>
                        <td style="padding-bottom:20px;">
                            <h1><b>Movies torrents</b> </h1>
                        </td>
                    </tr>
                </tbody>
            </table>
